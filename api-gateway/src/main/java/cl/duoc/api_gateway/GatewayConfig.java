...
public class GatewayConfig {
    ...
    @Bean
    public RouterFunction<ServerResponse> eventosApiDocsRoute() {
        return GatewayRouterFunctions.route("msvc_eventos_docs")
                .route(RequestPredicates.path("/eventos/api-docs"),
                        HandlerFunctions.http())
                .filter(LoadBalancerFilterFunctions.lb("msvc_eventos"))
                .build();
    }
    ...
    @Bean
    public RouterFunction<ServerResponse> recintosApiDocsRoute() {
        return GatewayRouterFunctions.route("msvc_recintos_docs")
                .route(RequestPredicates.path("/recintos/api-docs"),
                        HandlerFunctions.http())
                .filter(LoadBalancerFilterFunctions.lb("msvc_recintos"))
                .build();
    }
    ...
    @Bean
    public RouterFunction<ServerResponse> exponentesApiDocsRoute() {
        return GatewayRouterFunctions.route("msvc_exponentes_docs")
                .route(RequestPredicates.path("/exponentes/api-docs"),
                        HandlerFunctions.http())
                .filter(LoadBalancerFilterFunctions.lb("msvc_exponentes"))
                .build();
    }
    ...
    @Bean
    public RouterFunction<ServerResponse> preciosApiDocsRoute() {
        return GatewayRouterFunctions.route("msvc_precios_docs")
                .route(RequestPredicates.path("/precios/api-docs"),
                        HandlerFunctions.http())
                .filter(LoadBalancerFilterFunctions.lb("msvc_precios"))
                .build();
    }
    ...
    @Bean
    public RouterFunction<ServerResponse> ticketsApiDocsRoute() {
        return GatewayRouterFunctions.route("msvc_tickets_docs")
                .route(RequestPredicates.path("/tickets/api-docs"),
                        HandlerFunctions.http())
                .filter(LoadBalancerFilterFunctions.lb("msvc_tickets"))
                .build();
    }
    ...
    @Bean
    public RouterFunction<ServerResponse> resenasApiDocsRoute() {
        return GatewayRouterFunctions.route("msvc_resenas_docs")
                .route(RequestPredicates.path("/resenas/api-docs"),
                        HandlerFunctions.http())
