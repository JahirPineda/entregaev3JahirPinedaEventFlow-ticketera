package cl.duoc.msvc_precios.config;
...
public class OpenApiConfig {
    ...
    public OpenAPI customOpenAPI() {
        ...
        Info info = new Info()
                .title("Microservicio Precios - EventFlow")
                .description("API REST para gestión de precios y tipos de entrada de la plataforma EventFlow.")
                .version("1.0.0")
                .contact(contact)
