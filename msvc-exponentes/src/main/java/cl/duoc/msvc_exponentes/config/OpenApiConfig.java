package cl.duoc.msvc_exponentes.config;
...
public class OpenApiConfig {
    ...
    public OpenAPI customOpenAPI() {
        ...
        Info info = new Info()
                .title("Microservicio Exponentes - EventFlow")
                .description("API REST para gestión de exponentes y artistas de la plataforma EventFlow.")
                .version("1.0.0")
                .contact(contact)
